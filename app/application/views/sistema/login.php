    ...
    <section>
        ...
        <div class="panel panel-signin">
            ...
            <div class="panel-footer">
                ...
                <a href="signup" class="btn btn-primary btn-block">Registre-se agora!</a>
            </div><!-- panel-footer -->
        </div><!-- panel -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><?php echo $this->config->item('app_name'); ?> | <?php echo $this->config->item('app_version'); ?></h5>
