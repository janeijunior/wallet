...
class Sistema extends CI_Controller
{
    ...
    public function verificarLogin()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (count($usuario) > 0) {
                $dados = array('nome' => $usuario->nome, 'date_login' => date('d-m-Y H:m:s'),  'hora_login' => date('H:i:s'), 'url_logo' => $usuario->url_logo, 'url_ass' => $usuario->url_ass,  'id' => $usuario->idUsuarios, 'permissao' => $usuario->permissoes_id, 'logado' => TRUE);
